...
Escreva um algoritmo recursivo que resolva o
problema da torre de hanoi, seguindo as instruções:

    - A torre deve conter 3 discos, e três colunas;

    - Os discos começam alinhados na primeira coluna,
    e devem ser organizados respeitando a ordem de
    tamanho, na última coluna.
"""
...
if __name__ == "__main__":
    torres_hanoi(3, a='primeiro', b='meio', c='fim')
