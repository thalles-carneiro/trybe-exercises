...
bidimensional onde o valor 1 representa um computador
e 0 a ausência do mesmo. Dois servidores se comunicam
se eles estão na mesma linha ou mesma coluna.
...
if __name__ == "__main__":
    servidores = [[1, 0],
                  [1, 1]]
    resultado = count_servers(servidores)
