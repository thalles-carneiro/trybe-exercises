...
const getPlantById = (id) => defaultPlants.filter((plant) => plant.id === parseInt(id));

const removePlantById = (id) => { defaultPlants = defaultPlants.filter((plant) => plant.id !== parseInt(id)); };

const getPlantsThatNeedsSunWithId = (id) => defaultPlants.filter((plant) => plant.needsSun && plant.id === parseInt(id));
